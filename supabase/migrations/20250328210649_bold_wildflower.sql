/*
  ...
  1. New Tables
    - `growth_measurements`
      ...
      - `date` (timestamptz)
      - `weight` (numeric, must be positive)
      - `weight_unit` (text, either 'kg' or 'lb')
      - `height` (numeric, must be positive)
      - `height_unit` (text, either 'cm' or 'in')
      - `head_circumference` (numeric, must be positive)
      - `head_unit` (text, either 'cm' or 'in')
      - `notes` (text)
      - `created_at` (timestamptz)
  2. Security
    - Enable RLS
    - Add policies for creating, reading, and updating measurements
*/
